...
<?php get_template_part('templates/page', 'header'); ?>
		...
		<div class="row home-section">
			...
			<div class="col-sm-6 col-sm-pull-6">
				...
				<button class="btn btn-defualt btn-lg home-btn">View Pricing <i class="fa fa-chevron-right"></i></button>
			</div>
		</div>
		<div class="row home-section">
			<div class="col-sm-6">
			...
			<div class="col-sm-6">
				...
				<button class="btn btn-defualt btn-lg home-btn">Browse Themes <i class="fa fa-chevron-right"></i></button>
			</div>
		</div>
		<div class="row home-section video-section">
			<div class="col-sm-12">
				...
				<button class="btn btn-defualt btn-lg home-btn video-btn">Get quote <i class="fa fa-chevron-right"></i></button>
			</div>
		</div> 
