...
<?php get_template_part('templates/page', 'header'); ?>
		...
		<div class="row home-section">
			...
			<div class="col-sm-6">
				<h4>Websites.</h4>
				<p>"Jackalope is an open source company, which means that all the web templates we’ve built are available to you for free. The trick is to know how to install them, we can help you with that too in our tutoiral videos. If it’s still too hard, you can pay us to do it. How awesome is that?"</p>
